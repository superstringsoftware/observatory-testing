...
Package.on_use(function (api, where) {
  ...
  if (!process.env.METEOR_MOCHA_TEST_DIR && !process.env.METEOR_MOCHA_TEST_DIRS){
    console.log("METEOR_MOCHA_TEST_DIRS is undefined, defaulting to 'tests'");
      process.env.METEOR_MOCHA_TEST_DIR = "tests"
  }
  var path = require("path");
  var fs = require("fs");
  var util = require("util");

  api.add_files(["mochastub.js", "chai.js", "runOnServer.coffee"], ["server"]);
